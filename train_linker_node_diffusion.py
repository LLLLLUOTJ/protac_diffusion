...
from models.fragment_conditioned_denoiser import FragmentConditionedNodeDenoiser


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train fragment-conditioned linker-node diffusion on weak-anchor tensors")
    ...
    for batch in loader:
        ...
        with torch.set_grad_enabled(is_train):
            loss = diffusion.p_losses(
                ...
                loss_mask=linker_node["loss_mask"],
